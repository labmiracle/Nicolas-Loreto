...
function findSimulador ( arr: Simulador[] )
{
...
function filterSimulador ( arr: Simulador[] )
{
...
function reduceSimulador ( arr: Simulador[] )
{

    const reduced: Record<string, string> = arr.reduce( ( obj, e ) =>
    {
